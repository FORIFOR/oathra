...
import { PhoneRequestSchema, PHONE_PURPOSE_TEMPLATES } from '../../../packages/contract/dist/index.js';
...
export function phoneReadiness(service,config,user) {
 ...
 return {ready,provider:'Twilio',engine:'OpenAI',recording:false,newsAvailable:config.newsAvailable===true,
  issues,
