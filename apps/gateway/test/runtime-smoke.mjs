...
const [{CallRuntime},{PhoneTransport},{defineCall},{gptLiveEngine},voice]=await Promise.all([
...
assert.equal(c.goal,'sales.meeting');assert(gptLiveEngine({model:'explicit-test-model'}).speaksItself);
