...
try{
 ...
 await page.click('#phone-form button[type=submit]');await page.until("document.querySelector('#phone-review').open");assert.match(await page.text('#phone-dial'),/最大 400/);assert.match(await page.text('#phone-review-fields'),/0.01/);assert.match(await page.text('#phone-review-fields'),/157.888307.*2026-09-18/);assert.match(await page.text('#phone-disclosure'),/精算・差額返却/);
