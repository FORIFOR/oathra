...
${bold("Real phone")}
  oathra setup phone                 guided API-key, voice-engine and carrier setup (.env is updated)
                                     ${dim("--engine gpt-live|gemini-live|pipeline  --provider twilio|plivo|sip  --skip-test")}
  ...
  oathra call --to <e164>            place a call through your carrier          ${dim("--scenario <id|yaml>  --engine gpt-live|gemini-live|pipeline  --provider <id>")}
