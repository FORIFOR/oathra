...
Run **v0.1.12** with the latest fixes (Node.js 22+, no API key):

```bash
npx --yes --package=https://github.com/FORIFOR/oathra/releases/download/v0.1.12/oathra-0.1.12.tgz oathra demo
```

Distributed through [GitHub Releases](https://github.com/FORIFOR/oathra/releases/tag/v0.1.12). The npm command `npx oathra demo` still resolves to 0.1.0. For an instant browser trial, open the [evidence lab](https://forifor.github.io/oathra/en/#sim).
