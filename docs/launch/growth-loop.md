...
The latest 2026-09-14 16:06 JST readback remains 0 stars / 0 forks, 6 views / 6 unique visitors and 298 clones / 121 unique cloners in GitHub's 14-day window. v0.1.10's tarball and checksum each show one download, which is the maintainer's release verification and not adoption. These are distribution signals, not confirmed users. Zenn likes are 1 for `oathra-launch` and 0 for `oathra-evidence-rules`; GitHub Discussion #14 has two maintainer comments and no external replies, and no business inquiry has been observed.
...
Current X publication text: [x-transcript-check.txt](x-transcript-check.txt). This is the single active draft; older drafts in the publication history are superseded. A fresh public timeline read at 2026-09-14 16:54 JST showed newer account activity, with the newest post displayed as 1h (status `2099380959384899784`), followed by posts displayed as 2h and 14h. Because the exact timestamp is not exposed while logged out, conservatively defer the Oathra announcement until 2026-09-15 16:54 JST or later and recheck the live timeline immediately before publication. This supersedes the earlier 03:01 JST estimate. Do not classify a repost as a new original announcement, or invent outside engagement from the author's own activity.
