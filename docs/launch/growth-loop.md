...
The latest 2026-09-14 14:42 JST readback remains 0 stars / 0 forks, 6 views / 6 unique visitors and 298 clones / 121 unique cloners in GitHub's 14-day window; v0.1.8 assets had 0 downloads immediately after publication. These are distribution signals, not confirmed users. Zenn likes are 1 for `oathra-launch` and 0 for `oathra-evidence-rules`; no external feedback or business inquiry has been observed.
